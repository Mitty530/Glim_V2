...
export function AiDemo() {
  ...
  // Main return
  return (
    <section id="demo" ref={demoRef} className="py-24 relative">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="text-center mb-16">
            ...
            >
              Turn your meeting notes into actionable relationship insights in seconds
            </motion.p>
          </div>
          
          {/* Demo interface */}
          <div className="bg-white dark:bg-gray-800/95 rounded-2xl shadow-xl dark:shadow-2xl overflow-hidden border border-gray-200 dark:border-gray-700">
            {/* Demo Tabs */}
            <div className="border-b border-gray-200 dark:border-gray-700">
              <div className="flex">
                <button 
                  className={`px-6 py-4 font-medium transition-colors flex items-center ${activeInputTab === 'voice' ? 'text-brand-primary border-b-2 border-brand-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
                  onClick={() => {
                ...
                <button 
                  className={`px-6 py-4 font-medium transition-colors flex items-center ${activeInputTab === 'camera' ? 'text-brand-primary border-b-2 border-brand-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
                  onClick={() => {
                ...
                <button 
                  className={`px-6 py-4 font-medium transition-colors flex items-center ${activeInputTab === 'text' ? 'text-brand-primary border-b-2 border-brand-primary' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300'}`}
                  onClick={() => {
            ...
            <div className="p-6">
              <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="flex-1">
                  <div className="mb-4">
                    <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-2">Input</h3>
                    <p className="text-gray-600 dark:text-gray-300 text-sm">
                      {activeInputTab === 'voice' && "Record voice notes during meetings or calls"}
                      {activeInputTab === 'camera' && "Scan business cards or meeting notes"}
                      {activeInputTab === 'text' && "Type or paste your meeting notes"}
                    </p>
                  </div>
                  
                  <div className="bg-gray-100 dark:bg-gray-900 rounded-xl p-6 h-96 flex flex-col relative">
                    {!isPlaying ? (
